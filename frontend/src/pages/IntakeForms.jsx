    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-700 flex relative overflow-hidden">
      ...
      <main className="flex-1 p-10 relative z-10">
        <div className="bg-slate-800/50 backdrop-blur-lg shadow-xl rounded-3xl p-8 border border-slate-700/50 relative overflow-hidden">
          ...
          <div className="absolute -top-20 -right-20 w-40 h-40 bg-gradient-to-r from-slate-600/20 to-gray-600/20 rounded-full animate-pulse"></div>
          <div className="absolute -bottom-10 -left-10 w-60 h-60 bg-gradient-to-r from-gray-600/10 to-slate-600/10 rounded-full animate-pulse"></div>
          
          <h1 className="text-4xl font-extrabold bg-gradient-to-r from-gray-400 to-slate-400 bg-clip-text text-transparent mb-2">
            📄 My Intake Forms
          </h1>
          <p className="text-slate-300 text-lg max-w-2xl mb-8">
            Review all your submitted medical intake forms and information.
          </p>

          {loading && (
            <div className="flex items-center justify-center py-12">
              <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-gray-400"></div>
              <span className="ml-3 text-slate-300">Loading forms...</span>
            </div>
          )}
          ...
          {!loading && !err && forms.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-slate-400 text-lg mb-4">No intake forms submitted yet.</p>
              <Link 
                to="/patient/intake/submit" 
                className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 to-fuchsia-600 
                           hover:from-purple-500 hover:to-fuchsia-500 text-white font-medium rounded-lg transition-all duration-300"
              >
          ...
          {!loading && !err && forms.length > 0 && (
            <div className="relative z-10">
                ...
                {forms.map((form, index) => (
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      <div>
                        <h4 className="text-sm font-medium text-slate-300 mb-2">Medical History</h4>
                        <div className="bg-slate-600/20 rounded-lg p-4">
                          <p className="text-white text-sm leading-relaxed">
                            {form.medicalHistory || 'No medical history provided'}
                          </p>
                        </div>
                      </div>
                      ...
                      {form.insurance && (
                        <div>
                          <h4 className="text-sm font-medium text-slate-300 mb-2">Insurance Details</h4>
                          <div className="bg-slate-600/20 rounded-lg p-4">
                      ...
                      <div>
                        <h4 className="text-sm font-medium text-slate-300 mb-2">Current Symptoms</h4>
                        <div className="bg-slate-600/20 rounded-lg p-4">
                          <p className="text-white text-sm leading-relaxed">
                            {form.symptoms || 'No symptoms provided'}
                          </p>
                        </div>
                      </div>
                    </div>
              ...
              <div className="mt-8 flex gap-4">
                <Link 
                  to="/patient/intake/submit"
                  className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600/80 to-fuchsia-600/80 
                             hover:from-purple-500/80 hover:to-fuchsia-500/80 text-white font-medium rounded-xl 
